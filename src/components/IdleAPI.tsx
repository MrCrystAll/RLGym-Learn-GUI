...
function IdleAPI({startingAPI, error, isBugged}: IdleAPIArgs){
    ...
    if(isBugged){
      return <div className="d-flex justify-content-center align-items-center vh-100 flex-column bg-dark">
    ...
    return (
      ...
      <div className="pulse-wrapper mx-auto mb-5">
        ...
        <h4 className="fw-medium text-white">{startingAPI ? "Starting API..." : "API started"}</h4>
